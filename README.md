...
✅ This is a testing automation demo project that tests a real site
...
| ----------- | ----------- |
| **Java:**      | The project is developed using Python, providing a robust and widely used programming language for automation.       |
